...
public class Main {
	...
	public static void main(String[] args) {
        ...
        listaSeries[2]=new Serie("Los Simpsons", "Matt Groening", 25, "Humor");
        listaSeries[3]=new Serie("Padre de familia", "Humor" ,12, "Seth MacFarlane");
        listaSeries[4]=new Serie("Breaking Bad", "Thriller", 5, "Vince Gilligan");
  
        listaVideojuegos[0]=new Videojuego();
        listaVideojuegos[1]=new Videojuego("Assasin creed 2", 30, "Aventura", "EA");
        listaVideojuegos[2]=new Videojuego("Assasind crood 4", 320, "Aventura2", "Cosa");
